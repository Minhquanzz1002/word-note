...
public class VocabularyRepository extends BaseRepository<Vocabulary, Integer> {
     ...
     */
    public List<Vocabulary> getAllByCreator(Integer creator, String keyword, Integer offset, Integer limit) {
        return vocabularyMapper.getAllByCreator(creator, keyword, offset, limit);
    }
     ...
     */
    public boolean existsVocabularyByCreatorAndWord(Integer creator, String word) {
        return vocabularyMapper.existsVocabularyByCreatorAndWord(creator, word);
    }
}
